...
export const gameData = {
    allItems: [
        ...
        { name: "Iron Helm", price: 70, type: "armor", slot: "helmet", bonus: { strength: 1, maxHealth: 1, defense: 1 }, description: "A clunky metal helmet that protects your skull.", tier: 1, icon: "🪖", traits: ['Heavy', 'Physical', 'Tier 1'] },
        { name: "Iron Armor", price: 100, type: "armor", slot: "armor", bonus: { strength: 1, defense: 1, maxHealth: 1 }, description: "A rugged, full-metal suit offering solid protection against blades and claws, but it weighs heavy on speed.", tier: 1, icon: "👕", traits: ['Heavy', 'Physical', 'Tier 1'] },
        { name: "Steel Armor", price: 200, type: "armor", slot: "armor", bonus: { strength: 1, defense: 1, maxHealth: 1, physicalResistance: 1 }, description: "Tougher than iron and twice as shiny—now you can survive hits and look mildly impressive.", tier: 2, icon: "👕", traits: ['Heavy', 'Physical', 'Tier 2'] },
        { name: "Leather Armor", price: 100, type: "armor", slot: "armor", bonus: { agility: 1, maxHealth: 1 }, description: "Lightweight and flexible, offering modest protection without sacrificing mobility.", tier: 1, icon: "👕", traits: ['Medium', 'Physical', 'Tier 1'] },
        { name: "Leather Cowl", price: 70, type: "armor", slot: "helmet", bonus: { agility: 1, maxHealth: 1 }, description: "A simple leather cap that cushions light blows and keeps the elements at bay.", tier: 1, icon: "🪖", traits: ['Medium', 'Physical', 'Tier 1'] },
        { name: "Wizard Robe", price: 100, type: "armor", slot: "armor", bonus: { wisdom: 1, maxHealth: 1 }, description: "A flowing garment woven with faint arcane threads, offering minimal defense but aiding spell focus.", tier: 1, icon: "👘", traits: ['Light', 'Magical', 'Tier 1'] },
        { name: "Wizard Hat", price: 70, type: "armor", slot: "helmet", bonus: { wisdom: 1 }, description: "A pointed cap favored by mages, more for tradition than protection.", tier: 1, icon: "🧙", traits: ['Light', 'Magical', 'Tier 1'] },
        { name: "Amulet of Strength", price: 80, type: "accessory", slot: "accessory", bonus: { strength: 1 }, description: "+1 Strength", tier: 1, icon: "💎" },
        { name: "Iron Boots", price: 70, type: "armor", slot: "boots", bonus: { strength: 1, maxHealth: 1, defense: 1 }, description: "Heavy, loud, and not made for dancing.", tier: 1, icon: "👢", traits: ['Heavy', 'Physical', 'Tier 1'] },
        { name: "Leather Boots", price: 70, type: "armor", slot: "boots", bonus: { agility: 1 }, description: "Durable boots that provide basic foot protection and steady footing on rough terrain.", tier: 1, icon: "👢", traits: ['Medium', 'Physical', 'Tier 1'] },
        { name: "Cloth Boots", price: 70, type: "armor", slot: "boots", bonus: { wisdom: 1 }, description: "Lightweight boots designed for quiet steps and long days of spellcasting.", tier: 1, icon: "👢", traits: ['Light', 'Magical', 'Tier 1'] },
        ...
        { name: "Hemp", type: "material", price: 5, description: "A fibrous plant stalk, useful for making cloth.", icon: "🌿" },
        { name: "Carrot", type: "material", price: 5, description: "A crunchy, orange root vegetable.", icon: "🥕" },
    ...
    allSpells: [
        ...
        { name: "Dodge", cooldown: 2, school: "Physical", description: "Quickly leap out of harm's way. Less effective when you're clanking around in heavy armor.", type: "reaction", stat: "agility", hit: 10, icon: "🤸" },
