...
export const gameData = {
    allItems: [
        ...
        { name: "Staff", price: 0, type: "weapon", slot: "mainHand", hands: 2, cost: 1, cooldown: 2, stat: "wisdom", hit: 15, weaponType: "Two-Hand Staff", weaponDamage: 3, damageType: "Arcane", description: "1AP, 2CD | D20+Wis (15+) | Deals 3 Arcane Damage. Ranged.", tier: 1, icon: "🪄" },
        ...
        { name: "Quiver", price: 0, type: "accessory", slot: "accessory", grantsSlot: 'ammo', bonus: { agility: 1 }, description: "+1 Agility. Unlocks an Ammo slot.", tier: 1, icon: "🎒" },
        ...
        { name: "Leather Armor", price: 0, type: "armor", slot: "armor", bonus: { agility: 1, maxHealth: 1 }, description: "+1 Agility, +1 Max HP", tier: 1, icon: "👕" },
        { name: "Leather Cowl", price: 0, type: "armor", slot: "helmet", bonus: { agility: 1, maxHealth: 1 }, description: "+1 Agility, +1 Max HP", tier: 1, icon: "🪖" },
        { name: "Wizard Robe", price: 0, type: "armor", slot: "armor", bonus: { wisdom: 1, maxHealth: 1 }, description: "+1 Wisdom, +1 Max HP", tier: 1, icon: "👘" },
        { name: "Wizard Hat", price: 0, type: "armor", slot: "helmet", bonus: { wisdom: 1, maxHealth: 1 }, description: "+1 Wisdom, +1 Max HP", tier: 1, icon: "🧙" },
        { name: "Amulet of Strength", price: 80, type: "accessory", slot: "accessory", bonus: { strength: 1 }, description: "+1 Strength", tier: 1, icon: "💎" },
        { name: "Iron Boots", price: 0, type: "armor", slot: "boots", bonus: { strength: 1 }, description: "+1 Strength", tier: 1, icon: "👢" },
        { name: "Leather Boots", price: 0, type: "armor", slot: "boots", bonus: { agility: 1 }, description: "+1 Agility", tier: 1, icon: "👢" },
        { name: "Cloth Boots", price: 0, type: "armor", slot: "boots", bonus: { wisdom: 1 }, description: "+1 Wisdom", tier: 1, icon: "👢" },
