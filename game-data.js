...
export const gameData = {
    allItems: [
        ...
        { name: "Mugger's Knife", price: 150, type: "weapon", slot: ["mainHand", "offHand"], cost: 1, cooldown: 1, hit: 10, stat: "agility", weaponType: "Dagger", weaponDamage: 2, damageType: "Physical", description: "1AP, 1CD | D20+Agi (15+) | Deals 2 Physical Damage and applies Bleed.", onHit: { debuff: { type: 'bleed', duration: 2, damage: 1, damageType: 'Physical' } }, tier: 1, icon: "🔪" },
