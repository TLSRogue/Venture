...
export const allItems = [
    ...
    },
    {
        ...
        weaponDamage: 3,
        damageType: "Physical",
        description: "A finely crafted blade of polished steel. 1 AP, 1 CD | D20+Str (10+) | Deals 3 Physical Damage.",
        tier: 2,
        icon: "⚔️",
    ...
    },
    {
        ...
        description: "A massive steel blade. 1 AP, 2 CD | D20+Str (10+) | Deals 4 Phys Dmg. 15+: +1 Dmg.",
        tier: 2,
        icon: "🗡️",
    ...
    },
    {
        ...
        description: "A heavy steel crusher. 1 AP, 2 CD | D20+Str (10+) | Deals 4 Phys Dmg. 15+: Daze.",
        tier: 2,
        icon: "🔨",
        traits: ['Two-Handed', 'Melee', 'Tier 2'],
        rarity: "uncommon",
    ...
    },
    {
        ...
        description: "A massive cleaver. 1 AP, 2 CD | D20+Str (10+) | Deals 4 Phys Dmg. 15+: Bleed.",
        tier: 2,
        icon: "🪓",
        traits: ['Two-Handed', 'Melee', 'Tier 2'],
        rarity: "uncommon",
    ...
    },
    {
        ...
        damageType: "Arcane",
        bonus: { wisdom: 1 },
        description: "A finely crafted staff that channels arcane energy. 1 AP, 2 CD | D20+Wis (10+) | Deals 3 Arcane Damage. +1 Wisdom.",
        tier: 1,
        icon: "✨",
        traits: ['Staff', 'Ranged', 'Tier 1'],
        rarity: "rare",
    ...
    },
    {
        ...
        description: "Solid enough to stop a charging pig. 1 AP, 3 CD | D20+Def (10+) | Deals 2 Physical Damage. Reaction: Blocks 2 Damage.",
        tier: 1,
        icon: "🛡️",
        weaponDamage: 2,
        damageType: 'Physical',
